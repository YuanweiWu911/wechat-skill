...
Claude 在参与 `wechat-skill` 的分类、执行、回复时，必须遵守以下契约：
...
- `/wechat-skill` — 导入未读 + 审核 + 发送
- `/wechat-skill --limit 10` — 仅最近 10 条
- `/wechat-skill --all --limit 20` — 包含已读
